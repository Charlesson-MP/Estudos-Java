...
- __Exercícios de revisão:__
  ...
  - [x] __3.1)__ Exercícios sobre a utilização de algumas palavras chave como class e new, modificadores de acesso, métodos de entrada de dados, especificadores de formato, tipos de variáveis, etc.
  - [x] __3.2)__ Exercício para verificar a veracidade de algumas afirmações de acordo o que foi visto no capítulo, por exemplo, a estrutura e identificação de métodos, método construtor, uso de import, variáveis de ponto flutuante, entre outras.
  - [x] __3.3)__ Diferenciar variáveis locais e variáveis de instância.
  - [x] __3.4)__ Explicar o propósito de parâmetros nos métodos e a diferença entre parâmetro e argumento.
...
- __Questões:__
  ...
  - [x] __3.15)__ Criar um método chamado displayAccount para substituir as repetições das instruções de exibição e modificar a classe accountTest para usa-lo no lugar de tais instruções.
